# PURPOSE IS TO LOAD DATA AND GENERATE TEMPLATES FROM THE DATA
# ADDITIONAL PROCESSING CAN BE DONE BEFORE GENERATING THE TEMPLATES
...
# Load JSON data
with Path("portfolio_swe.json").open(encoding="utf-8") as f:
    data = json.load(f)
...
# Render the temmplate with the data
...
# ** is used to unpack the collection / iterable
